...
export default function Sidebar({ isMobileOpen, setMobileOpen }) {
  ...
  const safePalette = activePalette || {
    primary: "#39FF14",
    secondary: "#8A2BE2",
  };
  ...
  const content = (
    <div
      className={`flex w-64 h-full flex-col backdrop-blur-xl border-r ${theme.headerBg} ${theme.border}`}
    >
              ...
              >
                ...
                <item.icon
                  ...
                  style={{
                    ...
                    filter: isActive
                      ? `drop-shadow(0 0 8px ${safePalette.primary}CC)`
                      : undefined,
                  }}
                />
                <AnimatePresence>
      ...
      <div className={`p-4 border-t ${theme.border}`}>
        <div
          className={cn(
            "flex items-center gap-3 rounded-xl p-2 transition-all bg-black/5 dark:bg-white/5",
