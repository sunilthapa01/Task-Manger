...
export default function Navbar({ setMobileOpen }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-20 w-full items-center justify-between px-4 md:px-8 border-b border-black/5 bg-background/80 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-3 sm:gap-6 flex-1 justify-end">
        ...
        <div className="relative w-full max-w-xs hidden sm:block">
          ...
          <Input 
            ...
            className="pl-9 bg-black/5 border-transparent focus:bg-black/10"
          />
        </div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger onClick={() => setShowDropdown(!showDropdown)}>
            <div className="h-9 w-9 rounded-full bg-gradient-to-br from-primary to-accent p-0.5 cursor-pointer hover:scale-105 transition-transform duration-200">
